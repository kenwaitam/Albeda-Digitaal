<div class="layer3 documenten">
    ...
    <div class="container">
        ...
        <p>Hier zijn de documenten te vinden die we hebben gemaakt voor dit project.</p>
        <p> Elk groepslid heeft individueel een behoefteanalyse gemaakt en die is hier te downloaden.</p>

        <!-- Table with what, who, download link -->
        <table class="table table-hover">
            ...
            <!-- Row 5 Functioneel ontwerp Kees -->
            <tr>
            ...
            <!-- Row 6 Functioneel ontwerp Danny -->
            <tr>
                <td>Functioneel ontwerp</td>
                <td>Danny Tam</td>
                <td>
            ...
            <!-- Row 7 Functioneel ontwerp Niels -->
            <tr>
                <td>Functioneel ontwerp</td>
                <td>Niels Evers</td>
                <td>
            ...
            <!-- Row 8 Functioneel ontwerp Jurgen -->
            <tr>
                <td>Functioneel ontwerp</td>
                <td>Jurgen van der Heiden</td>
                <td>
